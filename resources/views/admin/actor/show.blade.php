        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex align-items-center">
                    ...
                    <a href="{{route('admin.actor.edit', $actor->id)}}" class="text-success"><i class="fas fa-solid fa-pen"></i></a>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table bg-white table-hover text-nowrap">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Img</td>
                                        <td><image width="100px" src="{{'/storage/app/public/' . $actor->image}}"></image></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
