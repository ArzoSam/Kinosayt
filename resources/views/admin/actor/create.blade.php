    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{route('admin.actor.store')}}" method="post" enctype="multipart/form-data" class=" mt-3">
                            @csrf
                            <div class="form-group">
                                <input type="text" class="form-control w-25" name="name" placeholder="Genre"
                                       value="{{ old('name') }}"
                                >
                                @error('name')
