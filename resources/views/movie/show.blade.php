    ...
    <div class="show_glav">
        <div class="pl-5 d-flex w-100 justify-content-between align-items-center no_hover">
            ...
            <div class="show_div">
                ...
                <p class="d-inline">Director : </p><a
                    href="{{route('director.show', $movie->directors->id)}}">{{$movie->directors->name}}</a>
                <p>Year of the movie : {{$movie->year}}</p>
                <div><p class="d-inline">Actors : </p>@foreach($movie->actors as $actor)<a class="d-inline"
                                                                                           href="{{route('actor.show', $actor->id)}}">{{$actor->name . ','}}  </a>@endforeach
                </div>
